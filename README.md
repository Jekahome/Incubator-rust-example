...
- [x] [0. Become familiar with Rust basics][Step 0]
- [x] [1. Key concepts][Step 1]
    - [x] [1.1. Type safety][Step 1.1]
    - [x] [1.2. `Rc`/`Weak`: reference counting][Step 1.2]
    - [x] [1.3. `Cell`/`RefCell`: interior mutability][Step 1.3]
    - [x] [1.4. `Cow`: clone-on-write][Step 1.4]
    - [x] [1.5. `Default`: default values][Step 1.5]
    - [x] [1.6. `Deref`: dereferencing][Step 1.6]
    - [x] [1.7. Static and dynamic dispatch][Step 1.7]
    - [x] [1.8. `Send`/`Sync`: thread safety][Step 1.8]
- 2. Primitives and tools
    - [x] [2.1. Date and time][Step 2.1]
    - [x] [2.2. Regular expressions][Step 2.2]
    - [x] [2.3. Bitmasks][Step 2.3]
    - [x] [2.4. Collections][Step 2.4]
    - [x] [2.5. Encoding and serialization][Step 2.5]
    - [x] [2.6. Randomness][Step 2.6]
    - [x] [2.7. Cryptography][Step 2.7]
    - [x] [2.8. Logging][Step 2.8]
    - [x] [2.9. Command-line arguments][Step 2.9]
    - [x] [2.10. Environment variables][Step 2.10]
    - [x] [2.11. Configuration][Step 2.11]
    - [x] [2.12. Threads, synchronization and parallelism][Step 2.12]
    - [x] [2.13. Futures and async I/O][Step 2.13]
    - [x] [2.14. Actors][Step 2.14]
    - [X] [2.15. Databases and ORMs][Step 2.15]
- 3. Architecture
